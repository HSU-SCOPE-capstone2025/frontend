...
### 📊 6. 대시보드
- 소셜 미디어 창작자의 사이버불링, 에코체임버 점수 도출 및 평균·영상별 점수 제공
- 리포트 생성, 대처방안 생성, 반대관점 콘텐츠 제안
<img width="100%" alt="scope_dashboard_image" src="https://github.com/user-attachments/assets/21d70077-eb57-483f-9731-dc6748acc5ed" />
...
### 🤖 8. 챗봇
- AI 챗봇 시스템
- 전체 인플루언서 통계, 특정일자 통계 보기, 콘텐츠 방향 추천, 칭찬 댓글 보기 등 여러 통계 및 인사이트 제공
<img width="100%" alt="scope_chatbot_image" src="https://github.com/user-attachments/assets/63250737-5f32-4b69-8b81-76a4ad469f32" />
