...
- 이주현: 화면 흐름 설계 및 UI/UX개발, 인플루언서 데이터 기반 소개·순위·분석·추천 기능 구현, 데이터 가공 기반 REST API연동 및 인터페이스 구현
...
## 📄 논문 투고
<img width="100%" alt="image" src="https://github.com/user-attachments/assets/b0db717c-b1bf-4015-a2ff-0f07feeabc62" />
